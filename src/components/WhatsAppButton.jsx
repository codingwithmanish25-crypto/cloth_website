...
const WhatsAppButton = () => {
    ...
    const defaultMessage= "Hi ! I have a question about my order/prodcut.";
  ...
  return (
    ...
    className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 transition-all duration-300 group cursor-pointer"
    >
        <svg
